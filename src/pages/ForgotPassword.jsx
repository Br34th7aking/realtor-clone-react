                ...
                <div className="w-full md:w-[40%] lg:w[-40%] md:ml-10 lg:ml-20">
                    <form className="w-full">
                        <input type="email" id="email" className="w-full mb-6 px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out" 
                         ...
                         placeholder="Email" />
                    <button className="w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800" type="submit">Send Reset Password link</button>
                    <div className='my-4 
