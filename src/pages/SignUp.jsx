            ...
            <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
                ...
                <div className="w-full md:w-[40%] lg:w[-40%] md:ml-10 lg:ml-20">
                    <form className="w-full">
                        <input type="text" id="name" className="w-full mb-6 px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out" 
                        ...
                        <div className='relative mb-6 '><input type={showPassword ? "text" : "password"} id="password" className="w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out"
                         ...
                         <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
                            <p className='mb-6'>Already have an account? <Link className="text-red-600 hover:text-red-700 transition duration-200 ease-in-out ml-1" to="/sign-in">Sign In</Link></p>
